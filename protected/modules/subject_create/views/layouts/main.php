...
<div class="container" id="page">
	...
	<div id="header">
		...
		$this->widget('bootstrap.widgets.TbMenu', array(		
		 ...
		 'stacked'=>false,
    'items'=>array(
        array('label'=>'Название', 'url'=>array(Yii::app()->createUrl('/Subject_create/subject/create'))),
        array('label'=>'Темы', 'url'=>array(Yii::app()->createUrl('/Subject_create/themes/create'))),
        array('label'=>'Расписание', 'url'=>array(Yii::app()->createUrl('/Subject_create/lesson/create'))),
    ),
		));?>
